...
export function SolutionsSection() {
    ...
    return (
        <div className="bg-[#f2bd00] py-16">
            <div className="max-w-7xl mx-auto px-4">
                <div className="mb-10">
                    <div className="bg-[#fff] text-[#F5C349] px-4 py-1 rounded-full text-sm font-medium inline-block mb-4">
                        {t('feature_badge')}
                    </div>
                    <h2 className="text-3xl md:text-4xl font-bold text-[#212b36] mb-4">
                        {t('title')}
                    </h2>
                    <p className="text-[#212b36] text-lg max-w-4xl">
                        {t('description')}
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#212b36] flex flex-col justify-between h-[520px] rounded-xl overflow-hidden">
                        <div className="p-6">
                            ...
                            <p className="text-gray-300 mb-6">{t('smart_order_management_description')}</p>
                        </div>
                        <Image
                    ...
                    <div className="bg-[#212b36] flex flex-col justify-between h-[520px] rounded-xl overflow-hidden">
                        <div className="p-6">
                            ...
                            <p className="text-gray-300 mb-6">{t('integrations_description')}</p>
                        </div>
                        <Image
                            src="/benefit/benefit-4.png"
                            alt="Multi-device synchronization"
